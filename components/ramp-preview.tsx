...
export function RampPreview({ swatches, surface }: Props) {
  ...
  return (
    <div
      className="rounded-2xl p-3 transition-colors sm:p-5"
        ...
        {swatches.map((s) => {
          ...
          return (
            <button
              ...
              className="group relative flex h-28 min-w-0 flex-1 flex-col justify-between gap-2 overflow-hidden rounded-lg p-1.5 text-left outline-none transition-transform hover:-translate-y-0.5 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-ring sm:h-44 sm:rounded-2xl sm:p-2.5"
            ...
            >
              ...
              <div className="hidden flex-col gap-0.5 sm:flex">
                ...
                <span className="font-mono text-[10px] tabular-nums opacity-60">
                  L {s.l.toFixed(2)} · C {s.c.toFixed(3)}
                </span>
              </div>
